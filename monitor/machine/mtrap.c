...
{
  die("machine mode: unhandlable trap %d @ %p eid is %ld mbadaddr %lx", read_csr(mcause), mepc, read_csr(mhartid), read_csr(mbadaddr));
}
...
send_ipi:
    ...
    /*case SBI_MEMORY_RECLAIM:
      retval = sm_mm_reclaim(arg0, arg1);
      break;*/
    ...
    case SBI_RUN_ENCLAVE:
      retval = sm_run_enclave(regs, arg0, arg1, arg2);
      break;
    ...
    case SBI_DESTROY_ENCLAVE:
      retval = sm_destroy_enclave(regs, arg0);
      break;
    ...
    case SBI_RUN_SHADOW_ENCLAVE:
      retval = sm_run_shadow_enclave(regs, arg0, arg1, arg2, arg3);
      break;
...
void redirect_trap(uintptr_t epc, uintptr_t mstatus, uintptr_t badaddr)
{
  ...
  printm("M mode: redirect trap %lx\r\n", badaddr);
...
{
  die("Machine mode: pmp_trap: mcause:%d, mepc:0x%x, tval:0x%x\r\n", mcause, mepc, read_csr(mbadaddr));
...
void enclave_call_trap(uintptr_t* regs, uintptr_t mcause, uintptr_t mepc)
{
  ...
  uintptr_t n = regs[17], arg0 = regs[10], arg1 = regs[11], arg2 = regs[12], arg3 = regs[13], arg4 = regs[14], retval;
  switch (n)
  {
    ...
    case SBI_ENCLAVE_RETURN:
      ...
      break;
    case SBI_YIELD:
      retval = sm_handle_yield(regs, mcause, mepc);
      break;
    case SBI_ASYN_ENCLAVE_CALL:
      retval = sm_asyn_enclave_call(regs, arg0, arg1);
      break;
    case SBI_SPLIT_MEM_REGION:
      retval = sm_split_mem_region(regs, arg0, arg1, arg2);
      break;
    default:
      retval = -ENOSYS;
      break;
