...
(struct regs
  ...
  [(define (equal-proc a b equal?-recur)
    (&& (equal?-recur (regs-ra a) (regs-ra b))
        ...
        (equal?-recur (regs-mip a) (regs-mip b))
        (equal?-recur (regs-mideleg a) (regs-mideleg b))
        (equal?-recur (regs-medeleg a) (regs-medeleg b))
        (equal?-recur (regs-mie a) (regs-mie b))))
...
(define (zero-regs)
  (regs (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64)
        ...
        (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64)
        (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64)
        (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64) (bv 0 64)))